...
public class EnemyShip extends Ship {
    ...
    float directionChangeFrequency = 0.75f; //Yön değiştirme sıklığı
    ...
    private void randomizeDirectionVector() {
        double bearing = SpaceShooterGame.random.nextDouble() * 6.283185; //0 dan 2*pi'ye
    ...
    public void draw(Batch batch) {
        ...
        if (shield > 0) {
            batch.draw(shieldTextureRegion, boundingBox.x, boundingBox.y - boundingBox.height * 0.2f,
    ...
    public String toString() {
        return "EnemyShip{" +
                ...
                ", timeSinceLastDirectionChange=" + timeSinceLastDirectionChange +
                ...
                ", shipTextureRegion=" + shipTextureRegion +
                ", shieldTextureRegion=" + shieldTextureRegion +
                ", laserTextureRegion=" + laserTextureRegion +
                '}';
    }
}
